      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            @auth
            <li class="nav-item"><a href="{{route('home') }}" class="nav-link">mon compte </li>
           ...
           <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
            ...
            @else
            <li class="nav-item"><a href="{{route('login') }}" class="nav-link">se connecter </li> 
            <li class="nav-item"><a href="{{route('register') }}" class="nav-link">s'enregistré </li> 
            @endauth
          </ul>
        </div>
      </div>
